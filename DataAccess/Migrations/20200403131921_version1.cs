        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImageFile = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QuotationText = table.Column<string>(nullable: true),
                    CurrentPage = table.Column<int>(nullable: false),
                    QuotesLike = table.Column<int>(nullable: false),
                    CreatedOn = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewLike = table.Column<int>(nullable: false),
                    Rating = table.Column<int>(nullable: false),
                    CreatedOn = table.Column<DateTime>(nullable: true),
                    UserId = table.Column<int>(nullable: true),
                    BookId = table.Column<int>(nullable: true)
